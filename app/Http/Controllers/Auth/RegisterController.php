...
class RegisterController extends Controller
{
    ...
    */
     ...
     * @var string
     */
    protected $redirectTo = RouteServiceProvider::VENDOR_DASHBOARD;
    ...
    protected function create(array $data)
    {
        ...
        //     // 'terms_condition' => isset($data['terms_condition']) ? 1 : 0,
        // ]);
        $vendor = new User();
        $vendor->name = $data['name'];
        $vendor->email = $data['email'];
        $vendor->password = Hash::make($data['password']);
        $vendor->terms_condition = isset($data['terms_condition']) ? 1 : 0;
        $vendor->save();
